...
@php
    ...
    $pageSubtitle = 'تعديل بيانات المستخدم ونوعه وصلاحياته';
@endphp
                ...
                <div class="grid-2">
                    <div class="form-group">
                        ...
                        <select name="role" id="role" required>
                            ...
                            <option value="results_viewer" {{ old('role', $user->role) == 'results_viewer' ? 'selected' : '' }}>عرض نتائج فقط</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small style="display:block; margin-top:8px; color:#6b7280;">
                            اتركي هذا الحقل فارغًا إذا لم تريدي تغيير كلمة المرور.
                        </small>
                    </div>
                </div>
...
<script>
    ...
    const oldDepartmentId = @json(old('department_id', $user->department_id));
